  ...
  return (
    <section className="era-select">
      ...
      <div className="era-options">
        ...
        >
          <span className="era-option__kind">Current season</span>
          ...
          <p>
            ...
            {modern.sprintRounds.size
              ...
              : ""}{" "}
            · Cadillac, Audi and the full modern grid.
          </p>
        </button>
        ...
        >
          ...
          <p>
            Senna&apos;s McLaren, Schumacher&apos;s Ferrari, the hybrid era —
            whatever season you want to break into.
          </p>
        </button>
      </div>
